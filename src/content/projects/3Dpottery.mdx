...
Design for function, and only function, is leaves me unsatisfied. But so does design for form (aka visual art, or lazy product design)!  The elegance of a design, for me, comes from the artful integration of a design's functionality, creation, or tech into its aesthetic.  

These pieces are.. some of the best ceramics I've ever created. Peak Karl art:
...
My ceramics don't need to hide their process of creation.  Rather, I make the process inseparable from the work itself by making the layer lines permanent and proudly displayed.  In my 3D printed pottery, the layer lines, and the timelapse videos of the printing process are both an important part of the completed work. 


## Did you know you can 3d print clay?
This page is intended as a gallery, so if you're here for the process then check out the [LF3DP](/projects/lf3dp) page for more details. Here's a quick teaser: a timelapse of the Spline Mug #16 being printed on the Autopot.ter conveyor.
